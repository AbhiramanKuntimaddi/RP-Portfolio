...
const initiatives = [
	...
	},
	{
		...
		role: "Founder",
		description:
			"A social initiative dedicated to community welfare, education, and empowering underserved communities through grassroots efforts.",
		icon: HeartHandshake,
...
export default function Initiatives() {
	...
	return (
		<section
			id="initiatives"
			className="relative bg-brand-paper py-24 md:py-32 px-6 md:px-16 overflow-hidden">
			<div className="max-w-6xl mx-auto">
				{/* HEADER SECTION - Synchronized Spacing */}
				<div className="mb-20 max-w-3xl">
					...
					<motion.p
						...
						I channel my entrepreneurial drive into specialized initiatives that
						create meaningful impact, both commercially through digital scale
						and socially through grassroots empowerment.
					</motion.p>
				</div>

				{/* 2-COLUMN GRID - Matching Services/About Rhythm */}
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
					{initiatives.map((item, index) => (
						<motion.div
							...
							{/* Visit Link - Custom Slide Animation */}
